...
TAGD_CONCEPT_IMPLEMENTS_FUNCTION( boolean_lattice, not_ )
TAGD_CONCEPT_IMPLEMENTS_FUNCTION( boolean_lattice, and_ )
TAGD_CONCEPT_IMPLEMENTS_FUNCTION( boolean_lattice, or_ )
